...
function avisoForm(a, users) {
  ...
  openModal({
    ...
    body: `<form id="f"><div class="form-grid">
      ...
      <div class="field"><label>Destinatarios</label><select name="audience" id="aud"><option value="todos" ${e.audience === 'todos' ? 'selected' : ''}>Todos</option><option value="comercial" ${e.audience === 'comercial' ? 'selected' : ''}>Comercial</option><option value="siniestros" ${e.audience === 'siniestros' ? 'selected' : ''}>Siniestros</option><option value="user" ${e.audience === 'user' ? 'selected' : ''}>Usuario especifico</option></select></div>
